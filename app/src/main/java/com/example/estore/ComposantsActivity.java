...
public class ComposantsActivity extends AppCompatActivity {
    ...
    private void ShowDialog(int pos) {
        Dialog dialog = new Dialog(ComposantsActivity.this);
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.item1:
                Intent a=new Intent(ComposantsActivity.this,AjoutActivity.class);
                startActivity(a);
                break;
            case R.id.item2:
                Intent b=new Intent(ComposantsActivity.this,RechercheActivity.class);
                startActivity(b);
                break;
        }
