...
public class MoniteursActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_moniteurs);
    ...
    private void ShowDialog(int pos) {
        Dialog dialog = new Dialog(MoniteursActivity.this);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menuajoutrecherche,menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()){
            case R.id.item1:
                Intent a=new Intent(MoniteursActivity.this,AjoutActivity.class);
                startActivity(a);
                break;
            case R.id.item2:
                Intent b=new Intent(MoniteursActivity.this,RechercheActivity.class);
                startActivity(b);
                break;
        }
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        getMenuInflater().inflate(R.menu.menusup,menu);
    }
